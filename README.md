...
Book recommendations start as AI-generated suggestions from **Meta-Llama-3-8B**, but are then **automatically verified and enriched** via the Google Books API:
...
**How it works:**
1. Llama 3 generates 3 book recommendations relevant to your field and region
